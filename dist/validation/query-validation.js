...
const sortByPropValidation = (0, express_validator_1.query)('sortBy').optional().custom((v, { req }) => {
...
// const pageNumberValidation = query('pageNumber').optional().isInt({}).default(1)
exports.queryValidation = [pageNumberValidation, sortDirectionValidation, pageSizeValidation, sortByPropValidation];
